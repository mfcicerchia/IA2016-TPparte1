...
public class IrLaboratorio extends SearchAction  {		
	    ...
	    public SearchBasedAgentState execute(SearchBasedAgentState s) {
	    	...
	    	// PREcondicion: 
			// * Si el agente tiene alguna habitacion adyacente del tipo 
			// * Si el agente tiene energia suficiente para moverse
			// * Si la habitacion LABORATORIO a la que se va a mover NO fue visitada
			// POScondicion
			// * El agente cambia de posicion, se mueve a la habitacion LABORATORIO
			// * Decrementa su energia segun el costo de moverse a ese LABORATORIO
