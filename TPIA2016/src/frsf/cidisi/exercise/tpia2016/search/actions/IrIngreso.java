...
public class IrIngreso extends SearchAction {
	
	
	
	String idIngreso;
	public IrIngreso(String idIngreso){
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		Habitacion h = agState.getMapa_ambiente().getHabitacionPorID(idIngreso);
